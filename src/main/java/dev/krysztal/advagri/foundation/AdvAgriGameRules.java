...
public class AdvAgriGameRules {
  ...
  public static final GameRules.Key<GameRules.BooleanRule> ALLOW_SEASONS_CHANGE = GameRuleRegistry.register(
    "allowSeasonsChange",
    GameRules.Category.UPDATES,
    GameRuleFactory.createBooleanRule(true)
  );

  public static final GameRules.Key<GameRules.IntRule> LENGTH_OF_YEAR = GameRuleRegistry.register(
    "lengthOfYear",
    GameRules.Category.UPDATES,
