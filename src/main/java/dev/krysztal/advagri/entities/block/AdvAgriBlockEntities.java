...
public class AdvAgriBlockEntities {
    ...
    @NotNull
    public static BlockEntityType<BambooBundleEntity> BAMBOO_BUNDLE_ENTITY;
    @NotNull
    ...
    static {
        BAMBOO_BUNDLE_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE,
                AdvAgriConstants.ADV_AGRI_NAMESPACE + ":bamboo_block",
                FabricBlockEntityTypeBuilder.create(BambooBundleEntity::new,
                        AdvAgriBlocks.BAMBOO_BUNDLE).build(null));
