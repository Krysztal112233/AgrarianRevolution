...
import tech.icedlab.advagri.AdvAgriItemGroup;
import tech.icedlab.advagri.item.tools.AdvAgriToolMaterials.AluminumMaterial;
import tech.icedlab.advagri.item.tools.AdvAgriToolMaterials.BronzeMaterial;
import tech.icedlab.advagri.item.tools.AdvAgriToolMaterials.CopperMaterial;
import tech.icedlab.advagri.item.tools.AdvAgriToolMaterials.LeadMaterial;
import tech.icedlab.advagri.item.tools.AdvAgriToolMaterials.NickelMaterial;
import tech.icedlab.advagri.item.tools.AdvAgriToolMaterials.SilverMaterial;
import tech.icedlab.advagri.item.tools.AdvAgriToolMaterials.SteelMaterial;
import tech.icedlab.advagri.item.tools.AdvAgriToolMaterials.TinMaterial;
import tech.icedlab.advagri.item.tools.AdvAgriToolMaterials.TitaniumMaterial;
import tech.icedlab.advagri.item.tools.AdvAgriToolMaterials.TungstenMaterial;
import tech.icedlab.advagri.item.tools.AdvAgriToolMaterials.ZincMaterial;
import tech.icedlab.advagri.item.tools.AdvAgriTools.AdvAgriAxeItem;
import tech.icedlab.advagri.item.tools.AdvAgriTools.AdvAgriHoeItem;
import tech.icedlab.advagri.item.tools.AdvAgriTools.AdvAgriPickaxeItem;
import tech.icedlab.advagri.item.tools.AdvAgriTools.AdvAgriShovelItem;
